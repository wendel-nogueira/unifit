...
Future<void> deleteTecadm(String token, int tecAdmId) async {
  String api = '$endpoint/tecadm/$tecAdmId';
  ...
  if (response.statusCode == 200) {
    showAlert('técnico administrativo excluído',
        'técnico administrativo excluído com sucesso!', 'success');
    ...
    showAlert(
        'erro ao excluir o técnico administrativo',
        'não foi possível excluir o técnico administrativo, tente novamente mais tarde!',
        'error');
  }
}
